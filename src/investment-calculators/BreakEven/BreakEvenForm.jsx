...
const initialPlaceholderData = {
  ...
  downPayment: 100000,
  closingCosts: 8000,
  closingCostsBreakdown: { legal: 3000, inspection: 2000, other: 3000 },
  rehabCost: 25000,
  furnishingsCost: 20000,
  lenderPoints: 1,
  ...
  occupancyRate: 60,
  occupiedNights: 18,
  seasonalUplift: [1.2, 1.1, 1, 0.9, 0.95, 1, 1.05, 1.1, 1.2, 1.3, 1.25, 1.2],
  cleaningFee: 150,
  channelFeePercent: 4,
  turnoverCost: 250,
  linenCost: 100,
